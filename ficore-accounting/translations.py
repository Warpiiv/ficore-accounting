TRANSLATIONS = {
    'en': {
        ...
        'core_something_went_wrong': 'Something went wrong, please try again',
        ...
        'core_switch_to': 'SwitchMaterials to',
    ...
    'ha': {
        ...
        'edit': 'Gyara',
        'delete': 'Share',
        'confirm_delete': 'Tabbatar da Sharewa',
        ...
        'core_something_went_wrong': 'Wani abu ya faru ba daidai ba, da fatan za a sake gwadawa',
