TRANSLATIONS = {
    'en': {
        ...
        'track_transaction': 'Add Transaction',
        ...
        'reset_password_subject': 'Password Reset Request for Ficore Ficore Records',
        ...
        # General
        'about_description': 'Ficore Ficore Records is a simplified software designed to empower small and medium enterprises (SMEs) across Africa with efficient financial record-keeping. Since 2025, we have been committed to making financial management accessible and intuitive.',
        ...
        'core_about_Ficore Records': 'About Ficore Ficore Records',
        ...
        'core_disclaimer_Ficore Records': 'Ficore Ficore Records is a simplified software for SMEs.',
        ...
        'core_Ficore Records_logo': 'Ficore Ficore Records Logo',
        ...
        'core_welcome_to_Ficore Records': 'Welcome to Ficore’s Ficore Records!',
        'rating': 'Rating (1-5)',
        'select_tool': 'Select Tool',
        'submit': 'Submit',
        'welcome': 'Welcome to Ficore Accounting',
        'home': 'Home',
        'invoices_desc': 'Create, edit, and track invoices',
        'transactions': 'Transactions',
        'transactions_desc': 'Record and view transactions',
        ...
        'create_invoice': 'Create Invoice',
        # Consent Banner
        'core_consent_banner_Ficore Records': 'By using Ficore Ficore Records, you understand that we provide tools for planning only, not banking.',
        # Errors
        'status': 'Status'
    },
    'ha': {
        ...
        'track_transaction': 'Ƙara Ma’amala',
        ...
        'reset_password_subject': 'Buƙatar Sake Saita Kalmar sirri don Ficore Ficore Records',
        ...
        # General
        'about_description': 'Ficore Ficore Records software ne mai sauƙi wanda aka ƙera don ƙarfafa ƙananan da matsakaitan kasuwanci (SMEs) a duk faɗin Afirka tare da ingantaccen adana bayanan kuɗi. Tun daga 2025, mun himmatu wajen sa sarrafa kuɗi ya zama mai sauƙi da fahimta.',
        ...
        'core_accept': 'Karba',
        'core_account': 'Asusu',
        'core_about_Ficore Records': 'Game da Ficore Ficore Records',
        ...
        'core_disclaimer_Ficore Records': 'Ficore Ficore Records software ne mai sauƙi don SMEs.',
        ...
        'core_Ficore Records_logo': 'Alamar Ficore Ficore Records',
        ...
        'core_welcome_to_Ficore Records': 'Maraba da Zuwa Ficore’s Ficore Records!',
        'rating': 'Ƙima (1-5)',
        'select_tool': 'Zaɓi Kayan Aiki',
        'submit': 'Aika',
        'welcome': 'Barka da zuwa! Sarrafa kasuwancinku cikin sauƙi.',
        'home': 'Gida',
        'invoices_desc': 'Ƙirƙira, gyara, da bin diddigin lissafin kuɗi',
        'transactions': 'Ma’amaloli',
        'transactions_desc': 'Rikodi da duba ma’amaloli',
        ...
        'core_consent_banner_Ficore Records': 'Ta amfani da Ficore Ficore Records, ka fahimci cewa muna ba da kayan aiki don shiri kawai, ba banki ba.',
        # Errors
        'status': 'Matsayi'
    }
}
