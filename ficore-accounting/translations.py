TRANSLATIONS = {
    'en': {
        ...
        'core_welcome_to_minirecords': 'Welcome to Ficore’s MiniRecords!',
    ...
    'ha': {
        ...
        'core_welcome_to_minirecords': 'Maraba da Zuwa Ficore’s MiniRecords!',
        ...
        'delete': 'Goge',
        'database_setup_success': 'An kammala saita bayanan bayanai cikin nasara.',
        'database_setup_error': 'Kuskure yayin saita bayanan bayanai. Don Allah a sake gwadawa.',
        'language_updated': 'An sabunta yare cikin nasara.',
        'invalid_language': 'An zaɓi yare mara inganci.',
        'feedback_success': 'An gabatar da ra\'ayi cikin nasara.',
        'feedback_error': 'Kuskure yayin gabatar da ra\'ayi. Don Allah a sake gwadawa.',
        ...
        'internal_server_error': 'Kuskuren ciki na sabar.',
        'edit': 'Gyara',
        ...
        # Module: core
        'core_invoice': 'An karɓa',
        'core_signup': 'Yi Rajista',
        'created_at': 'An Ƙirƙira Shi a',
        'pending': 'Mai Jiran Gado',
        'balance_summary': 'Takaitaccen Ma\'auni',
        'total_income': 'Jimillar Kuɗin Shiga',
        'total_expense': 'Jimillar Kuɗin Fita',
        'net_balance': 'Net Ma\'auni',
        'category_totals': 'Jimillar Rukunoni',
        'filter_date': 'Tace ta Kwanan Wata',
        'all_categories': 'Duk Rukunoni',
        'filter_description': 'Tace ta Bayani',
        'filter_tags': 'Tace ta Alamomi',
        'filter': 'Tace',
        'export_csv': 'Fitar da Bayanai',
        'tags': 'Alama',
        'recurring': 'Maimaitawa',
        'expense': 'Kuɗin Fita',
        'confirm_delete_message': 'Kana da tabbacin kana son share wannan abu?',
        'cancel': 'Soke',
        'income': 'Kuɗin Shiga',
        # Setup
