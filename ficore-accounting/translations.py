TRANSLATIONS = {
    'en': {
        ...
        'core_accept': 'Accept',
        'core_welcome_to_ficore_accounting': 'Welcome to Ficore Africa Accounting: Manage your invoices, transactions, and profile with confidence.',
    ...
    'ha': {
        ...
        'core_accept': 'Karba',
        'core_welcome_to_ficore_accounting': 'Maraba da Ficore Africa Accounting: Sarrafa lissafinka, ma’amalolinka, da bayananka cikin aminci.',
