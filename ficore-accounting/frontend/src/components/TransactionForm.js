...
function TransactionForm({ language }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.amount <= 0) {
      alert(translations.invalid_amount || 'Amount must be greater than zero');
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="needs-validation" noValidate>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            step="0.01"
          />
          <div className="invalid-feedback">{translations.invalid_amount || 'Please enter a valid amount'}</div>
        </div>
        <div className="mb-3">
          ...
          <input
            ...
            required
          />
          <div className="invalid-feedback">{translations.required_field || 'This field is required'}</div>
        </div>
        <div className="mb-3">
